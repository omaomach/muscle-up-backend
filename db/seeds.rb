...
c1 = Client.create!(name: "Joash", email: "mach@gmail.com", image: "https://production-next-images-cdn.thumbtack.com/i/447226666005553166/width/1024.jpeg", level: level.sample, password: "joash", age: 23, phone_number: "0728748441", trainer_id: trainer1.id, diet_type: "Weight gain", payment_info: payment_info.sample, weight: 72, target_weight: 90)
c2 = Client.create!(name: "Mike", email: "mike@gmail.com", image: "https://media.istockphoto.com/id/1320391277/photo/profile-view-powerful-mid-adult-woman-weightlifting-at-gym.jpg?s=612x612&w=0&k=20&c=SNkpSDm94jtkrYgLBuOWyrVdn4m7Jf7pgrbMRambQ-k=", level: level.sample, password: "joash", age: 24, phone_number: "0728748441", trainer_id: trainer1.id, diet_type: "Weight loss", payment_info: payment_info.sample, weight: 90, target_weight: 80)
c3 = Client.create!(name: "Nicole", email: "Nicole@gmail.com", image: "https://media.istockphoto.com/id/874837090/photo/young-woman-weightraining-at-the-gym.jpg?s=170667a&w=0&k=20&c=UU6Qu-aku4-bM5tR9QVdUHBSsw18fTvQwGZ3l4XlFNg=", level: level.sample, password: "joash", age: 27, phone_number: "0728748441", trainer_id: trainer1.id, diet_type: "Weight gain", payment_info: payment_info.sample, weight: 72, target_weight: 90)
c4 = Client.create!(name: "Kim", email: "Kim@gmail.com", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeAZyDAiIa801h9HPczskeCB9gJfoQjRSnBw&usqp=CAU", level: level.sample, password: "joash", age: 26, phone_number: "0728748441", trainer_id: trainer1.id, diet_type: "Weight gain", payment_info: payment_info.sample, weight: 72, target_weight: 90)
c5 = Client.create!(name: "Brain", email: "Brain@gmail.com", image: "https://img.freepik.com/premium-photo/handsome-man-good-shape-with-muscles-gym_219728-4174.jpg", level: level.sample, password: "joash", age: 28, phone_number: "0728748441", trainer_id: trainer1.id, diet_type: "Weight loss", payment_info: payment_info.sample, weight: 72, target_weight: 60)
c6 = Client.create!(name: "Ali", email: "Ali@gmail.com", image: "https://img.freepik.com/free-photo/attractive-fit-man-working-out-indoors-with-dumbbells_23-2149175334.jpg?w=2000", level: level.sample, password: "joash", age: 33, phone_number: "0728748441", trainer_id: trainer1.id, diet_type: "Weight gain", payment_info: payment_info.sample, weight: 72, target_weight: 90)
